...
const SelectCountry = Loadable({
  loader: () => import('./views/SalesOrder/SelectCountry'),
  loading: Loading,
});
...
const routes = [
  ...
  { path: '/SalesOrder', exact: true, name: 'Sales Order', component: SalesOrder },
  { path: '/SalesOrder/:erpOrder/:id', name: 'Sales Order Detail', component: SalesOrderDetail },

  { path: '/Inventory', name: 'Inventory', component: Inventory },
  { path: '/SalesOrder/test', name: 'test', component: SelectCountry },
  // { path: '/Inventory', name: 'Modals', component: Modals },
